#' Automated Anatomical Labeling in 2mm
#'
#' @name AAL_2mm
#' @docType data
#' @format A BrcParcellation object of size 91 x 109 x 91 voxels, of which
#' there are 185,405 voxels in representing the brain (20.5%). The parcellation is
#' not symmetric.
#' \describe{
